...
import 'motherstobelog_model.dart';
export 'motherstobelog_model.dart';

class MotherstobelogWidget extends StatefulWidget {
  const MotherstobelogWidget({Key? key}) : super(key: key);

  @override
  _MotherstobelogWidgetState createState() => _MotherstobelogWidgetState();
}

class _MotherstobelogWidgetState extends State<MotherstobelogWidget> {
  late MotherstobelogModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MotherstobelogModel());
